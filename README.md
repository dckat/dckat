...
## Study
 ...
 - [Spring Security](https://github.com/dckat/spring-security)
 - [Coding Test Study](https://github.com/SSGINCStudy/coding-test-study)
---
## Awards
 - 2019.10 가을 프로그래밍 경시대회 최우수상 (ACM-ICPC 국내대회 본선 참가)
 - 2021.05 봄 프로그래밍 경시대회 장려상 (경기 남부 6개대학 프로그래밍 대회 참가)
 - 2025.03 SSG I&C 백엔드 양성 5차수 최우수 프로젝트. 최우수 수료생
---
## Certification
 - 2020.08 정보처리기사
 - 2020.10 리눅스마스터 (2급)
